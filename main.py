...
from dataset_label.emotional import *
from dataset_label.imagenet import *
from dataset_label.coco128 import *
...
def main(WeightsPath):
    ...
    # 待测数据集标签选择
    label_exist = (emotion_label, coco128_label, imagenet_label)
    label_dict = {'0': 'emotion', '1': 'coco128', '2': 'imagenet'}
    # 打印所有已存在的标签
    print(f'可选择的【文本】标签：')
    for i in label_dict:
    ...
    # TODO 疑问1：检测准确率会随着detect()的循环次数增加而减少，已经确认不是模型加载的问题
    ...
    def detect(img):
        ...
        with torch.no_grad():
            ...
            for i in range(table_length):
                ...
                # 将英文标签转化为中文
                label_cn_dict = {0: emotional_dict, 1: '', 2: ''}  # 标签的中文翻译（以字典形式存储）
